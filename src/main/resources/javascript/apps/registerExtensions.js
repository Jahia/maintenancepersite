...
window.jahia.uiExtender.registry.add('callback', 'maintenancepersiteExample', {
    ...
    callback: function () {
        window.jahia.uiExtender.registry.add('adminRoute', 'maintenancepersiteExample', {
            ...
            icon: window.jahia.moonstone.toIconComponent('<svg aria-hidden="true" style="width:24px;height:24px" viewBox="0 0 24 24"><path fill="currentColor" d="M19 6V5A2 2 0 0 0 17 3H15A2 2 0 0 0 13 5V6H11V5A2 2 0 0 0 9 3H7A2 2 0 0 0 5 5V6H3V20H21V6M19 18H5V8H19Z" /></svg>'),
            isSelectable: true,
        ...
        window.jahia.uiExtender.registry.add('action', 'maintenancepersiteExample', {
            buttonIcon: window.jahia.moonstone.toIconComponent('<svg aria-hidden="true" style="width:24px;height:24px" viewBox="0 0 24 24"><path fill="currentColor" d="M19 6V5A2 2 0 0 0 17 3H15A2 2 0 0 0 13 5V6H11V5A2 2 0 0 0 9 3H7A2 2 0 0 0 5 5V6H3V20H21V6M19 18H5V8H19Z" /></svg>'),
